...
\begin{document}
  ...
  Representing the graph to a Laplacian matrix, we are able to compute the \textit{real-valued minimal cut} by solving for eigenvectors with corresponding minimal eigenvalues.
  This reads 
%  \begin{equation}
%\begin{alignedat}{2}
%    test &= \Omega + S\\
