function [segNew] = MinValueNormCut(img, mask, neighborhood, minval, currentSegmentation, viewSlice, numCuts, numIterations )
...
for s = 1:numIterations
    ...
    for m = 0:maxSegUpdating
        ...
        sSeg = var(img(segNew==m)) \ mean(img(segNew==m));
